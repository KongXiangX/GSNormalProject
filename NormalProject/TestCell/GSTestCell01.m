...
#import "GSTestCell01.h"

@interface GSTestCell01()
...
@implementation GSTestCell01

#pragma mark - 快速创建Cell
+ (instancetype)testCell01WithTableView:(UITableView *)tableView
{
    static NSString * GSTestCell01ID = @"GSTestCell01ID";
    GSTestCell01 *cell = [tableView dequeueReusableCellWithIdentifier:GSTestCell01ID];
    if (cell == nil) {
        cell = [[GSTestCell01 alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:GSTestCell01ID];
    }
    return cell;
}
