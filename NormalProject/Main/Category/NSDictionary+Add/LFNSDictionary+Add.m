...
@interface _LFXMLDictionaryParser : NSObject <NSXMLParserDelegate>
@end

@implementation _LFXMLDictionaryParser {
...
+ (NSDictionary *)lf_dictionaryWithXML:(id)xml {
    ...
    if ([xml isKindOfClass:[NSString class]]) {
        ...
        parser = [[_LFXMLDictionaryParser alloc] initWithData:xml];
    }
